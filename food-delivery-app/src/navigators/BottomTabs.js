...
export default () => (
  <BottomTabs.Navigator
    ...
    <BottomTabs.Screen
      name="Location"
      component={GMapLiveLocationScreen}
      options={{
        tabBarIcon: ({ color }) => (
          <Ionicons name="location-outline" size={23} color={color} />
        ),
      }}
      initialParams={{lat: '25.3646669182727', long: '68.38076493604409'}}
    />
